...
The knowledge network analysis follows Lydon-Staley et al. (2021) **in code logic only** — this is not a direct replication of that study. We adapt their graph-theoretical framework to a conversational AI context, in which "knowledge exploration" is operationalized through human–LLM exchanges rather than through free web browsing. For each participant:
